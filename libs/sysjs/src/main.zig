...
const js = struct {
    extern "zig" fn zigCreateMap() u32;
    extern "zig" fn zigCreateArray() u32;
    extern "zig" fn zigCreateString(str: [*]const u8, len: u32) u32;
    extern "zig" fn zigCreateFunction(id: *const anyopaque, captures: [*]Value, len: u32) u32;
    extern "zig" fn zigGetAttributeCount(id: u64) u32;
    extern "zig" fn zigGetProperty(id: u64, name: [*]const u8, len: u32, ret_ptr: *anyopaque) void;
    extern "zig" fn zigSetProperty(id: u64, name: [*]const u8, len: u32, set_ptr: *const anyopaque) void;
    extern "zig" fn zigDeleteProperty(id: u64, name: [*]const u8, len: u32) void;
    extern "zig" fn zigGetIndex(id: u64, index: u32, ret_ptr: *anyopaque) void;
    extern "zig" fn zigSetIndex(id: u64, index: u32, set_ptr: *const anyopaque) void;
    extern "zig" fn zigGetString(val_id: u64, ptr: [*]const u8) void;
    extern "zig" fn zigGetStringLength(val_id: u64) u32;
    extern "zig" fn zigValueEqual(val: *const anyopaque, other: *const anyopaque) bool;
    extern "zig" fn zigValueInstanceOf(val: *const anyopaque, other: *const anyopaque) bool;
    extern "zig" fn zigDeleteIndex(id: u64, index: u32) void;
    extern "zig" fn zigCopyBytes(id: u64, bytes: [*]u8, expected_len: u32) void;
    extern "zig" fn zigFunctionCall(id: u64, name: [*]const u8, len: u32, args: ?*const anyopaque, args_len: u32, ret_ptr: *anyopaque) void;
    extern "zig" fn zigFunctionInvoke(id: u64, args: ?*const anyopaque, args_len: u32, ret_ptr: *anyopaque) void;
    extern "zig" fn zigGetParamCount(id: u64) u32;
    extern "zig" fn zigConstructType(id: u64, args: ?*const anyopaque, args_len: u32) u32;
    extern "zig" fn zigCleanupObject(id: u64) void;
};
